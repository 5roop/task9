...
parser.add_argument('-o', '--outfile', required=True, help="Full path to desired output file.")
parser.add_argument('-p', '--processes', required=False, default=0, type=int, help="How many processes to use. If 0, use aggregation instead of recalculation (faster).")
...
if args.processes > 0:
    ...
    logging.info("Domain-level variant will be done by reassessing all significant words.")
